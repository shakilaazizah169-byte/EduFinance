                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" name="bill_to_nama"
                                           ...
                                           value="{{ old('bill_to_nama', $invoice->bill_to_nama) }}"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="bill_to_alamat" class="form-control" rows="3"
                                              placeholder="Jl. Nama Jalan No. XX&#10;RT/RW, Kelurahan, Kecamatan&#10;Kota, Provinsi, Kode Pos">{{ old('bill_to_alamat', $invoice->bill_to_alamat) }}</textarea>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Telepon</label>
                                    <input type="text" name="bill_to_telepon" class="form-control"
                                           value="{{ old('bill_to_telepon', $invoice->bill_to_telepon) }}" placeholder="0812xxxxxxxx">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Email</label>
                                    <input type="email" name="bill_to_email" class="form-control"
                                           value="{{ old('bill_to_email', $invoice->bill_to_email) }}" placeholder="email@perusahaan.com">
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr class="item-row">
                                            ...
                                            <td>
                                                <input type="number" name="items[{{ $idx }}][unit_cost]" 
                                                       class="form-control form-control-sm border-0 text-end unit-cost-input" 
                                                       min="0" value="{{ $item->unit_cost }}" step="1000" required>
                                            </td>
                                            <td>
                                                <input type="text" name="items[{{ $idx }}][amount]" 
                                                       class="form-control form-control-sm border-0 text-end amount-display" 
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <textarea name="catatan_bank" class="form-control" rows="2"
                                              placeholder="Informasi rekening untuk pembayaran...">{{ old('catatan_bank', $invoice->catatan_bank) }}</textarea>
                                </div>
                                <div class="col-12">
                                    <label class="form-label">Pesan Penutup</label>
                                    <input type="text" name="pesan_penutup" class="form-control"
                                           value="{{ old('pesan_penutup', $invoice->pesan_penutup) }}"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="catatan_tambahan" class="form-control" rows="2"
                                              placeholder="Catatan lain jika diperlukan...">{{ old('catatan_tambahan', $invoice->catatan_tambahan) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="subtotalDisplay" class="form-control text-end" readonly value="{{ number_format($invoice->subtotal, 0, ',', '.') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" name="tax_rate" id="taxRate"
                                           class="form-control text-end" min="0" max="100" step="0.1" 
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="text" id="salesTaxDisplay" class="form-control text-end" readonly 
                                           value="{{ number_format($invoice->sales_tax, 0, ',', '.') }}">
                                    <input type="hidden" name="sales_tax" id="salesTaxInput" value="{{ $invoice->sales_tax }}">
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="other" id="otherInput"
                                           ...
                                           value="{{ old('other', $invoice->other) }}" step="1000">
                                </div>
                            </div>
                            <hr>
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="totalDisplay" class="form-control text-end fw-bold" readonly 
                            ...
                            <div class="mb-0">
                                ...
                                <textarea id="terbilangDisplay" name="terbilang" class="form-control"
                                          rows="2" readonly style="font-style:italic; font-size:.85rem;">{{ $invoice->terbilang }}</textarea>
                            </div>
                        </div>
                        <div class="card-footer">
                            <div class="d-grid gap-2">
                                <button type="submit" name="action" value="save" class="btn btn-primary">
                                    <i class="feather-save me-2"></i>Update Invoice
                                </button>
                                <button type="submit" name="action" value="save_print" class="btn btn-success">
                                    <i class="feather-printer me-2"></i>Update & Cetak PDF
                                </button>
                                <a href="{{ route('invoice.index') }}" class="btn btn-outline-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Recalculate after page load to ensure correct values
