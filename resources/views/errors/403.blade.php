...
<head>
    ...
    <title>403 — Akses Ditolak | EduFinance</title>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .bg-orb {
            ...
            background: radial-gradient(circle, rgba(18,70,160,0.07) 0%, transparent 70%);
        ...
        .grid-bg {
            ...
            background-image: linear-gradient(rgba(18,70,160,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(18,70,160,0.03) 1px, transparent 1px);
        ...
        .error-desc {
            font-size: 15px; color: var(--muted); max-width: 400px;
        ...
        .btn-primary {
            ...
            box-shadow: 0 4px 16px rgba(18,70,160,0.25);
        }
...
<body>
    ...
    <div class="wrap">
        ...
        <p class="error-desc">
            ...
            Pastikan Anda login dengan akun yang tepat, atau hubungi administrator.
        </p>
        <div class="actions">
