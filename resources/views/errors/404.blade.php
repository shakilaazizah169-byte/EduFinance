...
<head>
    ...
    <title>404 — Halaman Tidak Ditemukan | EduFinance</title>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @keyframes floatOrb { 0%, 100% { transform: translateX(-50%) translateY(0); } 50% { transform: translateX(-50%) translateY(-18px); } }
        .grid-bg {
        ...
        .error-url {
            ...
            background: rgba(18,70,160,0.05); border: 1px solid var(--border);
            border-radius: 8px; padding: 8px 16px; margin-bottom: 40px;
...
<body>
    ...
    <div class="wrap">
        ...
        <div class="error-url">{{ request()->url() }}</div>
        <div class="actions">
